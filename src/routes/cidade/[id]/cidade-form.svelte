<script lang="ts">
    ...
    $formData.nome = data.city.nome;

    let nome = $state(data.city.nome)
    let state_id = $state(data.city.state_id);
    let state_nome = $state(data.city.state_nome);
...
<form method="POST" use:enhance>
    ...
    <Form.Button name="action" value="update" style="float: right; margin-right: 1em;" >Salvar</Form.Button>
</form>