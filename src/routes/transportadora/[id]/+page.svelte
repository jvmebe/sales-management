<script lang="ts">
	...
	let { data } = $props(); // Usando a sintaxe correta do Svelte 5
	...
	function confirmDelete(e: Event) {
		if (!confirm('Tem certeza que deseja deletar esta transportadora? Esta ação não pode ser desfeita.')) {
			e.preventDefault();
		}
	}
</script>
...
<div class="mb-4 flex items-center gap-4">
	...
	<h1 class="text-2xl font-bold">Editar Transportadora: {data.transportadora.nome}</h1>
</div>
